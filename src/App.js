    ...
    useEffect(() => {
        ...
        setInterval(() => {
            ...
            if (collides(driftingCar_1, bottomWall) === true) {
                ...
                driftingCar_1.x = driftingCar_1.x - 3
                car_1.style.left = driftingCar_1.x + 'px'
            } else if (collides(driftingCar_1, first_turn_out) === true) {
                driftingCar_1.x = driftingCar_1.x - 3
                car_1.style.left = driftingCar_1.x + 'px'
            } else if (collides(driftingCar_1, first_turn_in) === true) {
                driftingCar_1.x = driftingCar_1.x + 3
                car_1.style.left = driftingCar_1.x + 'px'
            } else if (collides(driftingCar_1, second_turn_out) === true) {
                driftingCar_1.y = driftingCar_1.y - 3
                car_1.style.top = driftingCar_1.y + 'px'
            } else if (collides(driftingCar_1, second_turn_in) === true) {
                driftingCar_1.y = driftingCar_1.y + 3
                car_1.style.top = driftingCar_1.y + 'px'
            } else if (collides(driftingCar_1, third_turn_out) === true) {
                driftingCar_1.x = driftingCar_1.x + 3
                car_1.style.left = driftingCar_1.x + 'px'
            } else if (collides(driftingCar_1, third_turn_in) === true) {
                driftingCar_1.x = driftingCar_1.x - 3
                car_1.style.left = driftingCar_1.x + 'px'
            } else if (collides(driftingCar_1, fourth_turn_out) === true) {
                driftingCar_1.y = driftingCar_1.y - 3
                car_1.style.top = driftingCar_1.y + 'px'
            } else if (collides(driftingCar_1, fourth_turn_in) === true) {
                driftingCar_1.y = driftingCar_1.y + 3
                car_1.style.top = driftingCar_1.y + 'px'
            } else if (collides(driftingCar_1, finish) === true) {
                setCountY((prev) => prev + 1)
                    driftingCar_1.x = 20
                driftingCar_1.y = 750
                driftingCar_1.rotate = -90
                car_1.style.top = driftingCar_1.y + 'px'
                car_1.style.left = driftingCar_1.x + 'px'
                car_1.style.transform = `rotate(${driftingCar_1.rotate}deg)`
            ...
            if (collides(driftingCar_2, bottomWall) === true) {
                ...
                driftingCar_2.x = driftingCar_2.x - 3
                car_2.style.left = driftingCar_2.x + 'px'
            }else if (collides(driftingCar_2, first_turn_out) === true) {
                driftingCar_2.x = driftingCar_2.x - 3
                car_2.style.left = driftingCar_2.x + 'px'
            } else if (collides(driftingCar_2, first_turn_in) === true) {
                driftingCar_2.x = driftingCar_2.x + 3
                car_2.style.left = driftingCar_2.x + 'px'
            } else if (collides(driftingCar_2, second_turn_out) === true) {
                driftingCar_2.y = driftingCar_2.y - 3
                car_2.style.top = driftingCar_2.y + 'px'
            } else if (collides(driftingCar_2, second_turn_in) === true) {
                driftingCar_2.y = driftingCar_2.y + 3
                car_2.style.top = driftingCar_2.y + 'px'
            } else if (collides(driftingCar_2, third_turn_out) === true) {
                driftingCar_2.x = driftingCar_2.x + 3
                car_2.style.left = driftingCar_2.x + 'px'
            } else if (collides(driftingCar_2, third_turn_in) === true) {
                driftingCar_2.x = driftingCar_2.x - 3
                car_2.style.left = driftingCar_2.x + 'px'
            } else if (collides(driftingCar_2, fourth_turn_out) === true) {
                driftingCar_2.y = driftingCar_2.y - 3
                car_2.style.top = driftingCar_2.y + 'px'
            } else if (collides(driftingCar_2, fourth_turn_in) === true) {
                driftingCar_2.y = driftingCar_2.y + 3
                car_2.style.top = driftingCar_2.y + 'px'
            } else if (collides(driftingCar_2, finish) === true) {
                setCountB((prev) => prev + 1)
                driftingCar_2.x = 90
                driftingCar_2.y = 750
                driftingCar_2.rotate = -90
                car_2.style.top = driftingCar_2.y + 'px'
                car_2.style.left = driftingCar_2.x + 'px'
                car_2.style.transform = `rotate(${driftingCar_2.rotate}deg)`
        ...
        <div>
            ...
            <div style={{color:'blue', fontWeight:'bold', fontSize:"40px"}}> BLUE POINTS : {countBlue} </div>
                ...
                <div className={'field'} onKeyDown={move()} onKeyUp={stop()}>
                    <div className={'cars'}>
                        <i id={'driftingCar_1'} style={{color: '#3A75C4 ', fontSize: '60px'}}
                           className="fas fa-fighter-jet"> </i>
                        <i id={'driftingCar_2'} style={{color: '#FDE910 ', fontSize: '60px'}}
                           className="fas fa-fighter-jet"> </i>
                    </div>
                    <div className={'walls'}>
                        <div id={'first_turn'}>
